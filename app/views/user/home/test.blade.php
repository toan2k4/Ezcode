...
@section('content')
    ...
    <main class="main-area fix">
        ...
        <section class="banner-area banner-bg tg-motion-effects"
            data-background="app/public/user/assets/img/banner/banner_bg.png">
            <div class="container">
                <div class="row justify-content-between align-items-start">
                        ...
                        <div class="banner__content">
                            <h3 class="title tg-svg" data-aos="fade-right" data-aos-delay="400">
                                ...
                                <span class="position-relative">
                                    <span class="svg-icon" id="banner-svg"
                                        data-svg-icon="app/public/user/assets/img/objects/title_shape.svg"></span>
                            ...
                            <div class="banner__btn-wrap" data-aos="fade-right" data-aos-delay="800">
                                <a href="contact.html" class="btn arrow-btn">Start Free Trial <img
                                        src="app/public/user/assets/img/icons/right_arrow.svg" alt="img"
                                        class="injectable"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="banner__images">
                            <img src="app/public/user/assets/img/banner/banner_img.png" alt="img" class="main-img">
                            <div class="shape big-shape" data-aos="fade-up-right" data-aos-delay="600">
                                <img src="app/public/user/assets/img/banner/banner_shape01.png" alt="shape"
                                    class="tg-motion-effects1">
                            </div>
                            <img src="app/public/user/assets/img/banner/bg_dots.svg" alt="shape"
                                class="shape bg-dots rotateme">
                            <img src="app/public/user/assets/img/banner/banner_shape02.png" alt="shape"
                                class="shape small-shape tg-motion-effects3">
                            <div class="banner__author">
                                <div class="banner__author-item">
                                    <div class="image">
                                        <img src="app/public/user/assets/img/banner/banner_author01.png" alt="img">
                                    </div>
                                    <h6 class="name">Robert Fox</h6>
                                </div>
                                <div class="banner__author-item">
                                    <div class="image">
                                        <img src="app/public/user/assets/img/banner/banner_author02.png" alt="img">
                                    </div>
                                    <h6 class="name">Michel Jones</h6>
                                </div>
                                <img src="app/public/user/assets/img/banner/banner_shape02.svg" alt="shape"
            ...
            <img src="app/public/user/assets/img/banner/banner_shape01.svg" alt="shape" class="line-shape"
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-9">
                        <div class="about__images">
                            <img src="app/public/user/assets/img/others/about_img.png" alt="img" class="main-img">
                            <img src="app/public/user/assets/img/others/about_shape.svg" alt="img"
                            ...
                            <div class="about__enrolled" data-aos="fade-right" data-aos-delay="200">
                                ...
                                <img src="app/public/user/assets/img/others/student_grp.png" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <section class="courses-area section-pt-120 section-pb-90"
            data-background="app/public/user/assets/img/bg/courses_bg.jpg">
            <div class="container">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="courses__nav">
                                <ul class="nav nav-tabs" id="courseTab" role="tablist">
                                    ...
                                    @foreach ($data['category'] as $item)
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="{{ $item['id'] }}-tab" data-bs-toggle="tab"
                                                data-bs-target="#{{ $item['id'] }}-tab-pane" type="button"
                                                role="tab" aria-controls="{{ $item['id'] }}-tab-pane"
                                                aria-selected="false">
                                                {{ $item['name'] }}
                                            </button>
                                        </li>
                ...
                <div class="tab-content" id="courseTabContent">
                            ...
                            <div class="swiper-wrapper">
                                        ...
                                        <div class="courses__item shine__animate-item">
                                            <div class="courses__item-thumb">
                                                <a href="course-details.html" class="shine__animate-link">
                                                    <img src="app/public/image/{{ $item['thumbnail'] }}" alt="img">
                                                </a>
                                            </div>
                                            <div class="courses__item-content">
                                                <ul class="courses__item-meta list-wrap">
                                                    <li class="courses__item-tag">
                                                        <a href="course.html">{{ $item['name_category'] }}</a>
                                                    </li>
                                                    <li class="avg-rating"><i class="fas fa-star"></i> (4.8 Reviews)</li>
                                                </ul>
                                                <h5 class="title"><a href="course-details.html">{{ $item['name'] }}</a>
                                                </h5>
                                                <p class="author">By <a href="#">{{ $item['username'] }}</a></p>
                                ...
                                <div class="swiper-slide">
                                    <div class="courses__item shine__animate-item">
                                        <div class="courses__item-thumb">
                                            <a href="course-details.html" class="shine__animate-link">
                                                <img src="app/public/user/assets/img/courses/course_thumb02.jpg"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="courses__item-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="courses__item shine__animate-item">
                                        <div class="courses__item-thumb">
                                            <a href="course-details.html" class="shine__animate-link">
                                                <img src="app/public/user/assets/img/courses/course_thumb03.jpg"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="courses__item-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="courses__item shine__animate-item">
                                        <div class="courses__item-thumb">
                                            <a href="course-details.html" class="shine__animate-link">
                                                <img src="app/public/user/assets/img/courses/course_thumb04.jpg"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="courses__item-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="courses__item shine__animate-item">
                                        <div class="courses__item-thumb">
                                            <a href="course-details.html" class="shine__animate-link">
                                                <img src="app/public/user/assets/img/courses/course_thumb05.jpg"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="courses__item-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="courses__item shine__animate-item">
                                        <div class="courses__item-thumb">
                                            <a href="course-details.html" class="shine__animate-link">
                                                <img src="app/public/user/assets/img/courses/course_thumb06.jpg"
                                                    alt="img">
                                            </a>
                                        </div>
                                        <div class="courses__item-content">
                    ...
                    {{-- @foreach ($data['category'] as $item)
                        <div class="tab-pane fade" id="{{ $item['id'] }}-tab-pane" role="tabpanel"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="courses__item shine__animate-item">
                                            <div class="courses__item-thumb">
                                                <a href="course-details.html" class="shine__animate-link">
                                                    <img src="app/public/user/assets/img/courses/course_thumb01.jpg"
                                                        alt="img">
                                                </a>
                                            </div>
                                            <div class="courses__item-content">
        ...
        <section class="newsletter__area">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <div class="newsletter__img-wrap">
                            <img src="app/public/user/assets/img/others/newsletter_img.png" alt="img">
                            <img src="app/public/user/assets/img/others/newsletter_shape01.png" alt="img"
                                data-aos="fade-up" data-aos-delay="400">
                            <img src="app/public/user/assets/img/others/newsletter_shape02.png" alt="img"
            ...
            <div class="newsletter__shape">
                <img src="app/public/user/assets/img/others/newsletter_shape03.png" alt="img" data-aos="fade-left"
                    data-aos-delay="400">
            </div>
        </section>
        <!-- newsletter-area-end -->
                            ...
                            <div class="row">
                                    ...
                                    <div class="instructor__item">
                                        <div class="instructor__thumb">
                                            <a href="instructor-datails.html"><img
                                                    src="app/public/user/assets/img/instructor/instructor01.png"
                                                    alt="img"></a>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="instructor__item">
                                        <div class="instructor__thumb">
                                            <a href="instructor-datails.html"><img
                                                    src="app/public/user/assets/img/instructor/instructor02.png"
                                                    alt="img"></a>
                                        </div>
                                        <div class="instructor__content">
                                ...
                                <div class="col-sm-6">
                                    <div class="instructor__item">
                                        <div class="instructor__thumb">
                                            <a href="instructor-datails.html"><img
                                                    src="app/public/user/assets/img/instructor/instructor03.png"
                                                    alt="img"></a>
                                        </div>
                                        <div class="instructor__content">
                                ...
                                <div class="col-sm-6">
                                    <div class="instructor__item">
                                        <div class="instructor__thumb">
                                            <a href="instructor-datails.html"><img
                                                    src="app/public/user/assets/img/instructor/instructor04.png"
                                                    alt="img"></a>
                                        </div>
                                        <div class="instructor__content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="faq__img-wrap tg-svg">
                            ...
                            <div class="faq__img">
                                <img src="app/public/user/assets/img/others/faq_img.png" alt="img">
                                <div class="shape-one">
                                    <img src="app/public/user/assets/img/others/faq_shape01.svg"
                                        class="injectable tg-motion-effects4" alt="img">
                                </div>
                                <div class="shape-two">
                                    <span class="svg-icon" id="faq-svg"
                                        data-svg-icon="app/public/user/assets/img/others/faq_shape02.svg"></span>
                                </div>
                            </div>
                        </div>
                    </div>
