...
<main class="main-area fix">
    ...
    <div class="breadcrumb__area breadcrumb__bg breadcrumb__bg-two" data-background="public/assets/img/bg/breadcrumb_bg.jpg">
                ...
                <div class="col-12">
                    <div class="breadcrumb__content">
                        <nav class="breadcrumb">
                            ...
                            <span class="breadcrumb-separator"><i class="fas fa-angle-right"></i></span>
                            <span property="itemListElement" typeof="ListItem">{{$data['course']['name']}}</span>
                        </nav>
                    </div>
                </div>
            </div>
        ...
        <div class="breadcrumb__shape-wrap">
            <img src="{{BASE_URL}}/app/public/user/assets/img/others/breadcrumb_shape01.svg" alt="img" class="alltuchtopdown">
            <img src="{{BASE_URL}}/app/public/user/assets/img/others/breadcrumb_shape02.svg" alt="img" data-aos="fade-right" data-aos-delay="300">
            <img src="{{BASE_URL}}/app/public/user/assets/img/others/breadcrumb_shape03.svg" alt="img" data-aos="fade-up" data-aos-delay="400">
            <img src="{{BASE_URL}}/app/public/user/assets/img/others/breadcrumb_shape04.svg" alt="img" data-aos="fade-down-left" data-aos-delay="400">
            <img src="{{BASE_URL}}/app/public/user/assets/img/others/breadcrumb_shape05.svg" alt="img" data-aos="fade-left" data-aos-delay="400">
        </div>
    </div>
    <!-- breadcrumb-area-end -->
            ...
            <div class="row">
                <div class="col-xl-9 col-lg-8">
                    <div class="courses__details-thumb">
                        <img src="<?= BASE_URL?>app/public/image/<?= $data['course']['thumbnail']?>" alt="img">
                    </div>
                    <div class="courses__details-content">
                        ...
                        <h2 class="title">{{$data['course']['name']}}</h2>
                        <div class="courses__details-meta">
                            <ul class="list-wrap">
                                <li class="author-two">
                                    <img src="{{BASE_URL}}app/public/image/{{$data['instructor']['avata']}}" alt="img">
                                    By
                                    <a href="#">{{$data['instructor']['username']}}</a>
                                </li>
                                                            ...
                                                            <a href="#" class="course-item-link">
                                                                ...
                                                                <div class="course-item-meta">
                                                                    ...
                                                                    <span class="item-meta course-item-status">
                                                                        <img src="{{BASE_URL}}/app/public/user/assets/img/icons/lock.svg" alt="icon">
                                                                    </span>
                                                                </div>
                                                            </a>
                                                        </li>
                            ...
                            <div class="tab-pane fade" id="instructors-tab-pane" role="tabpanel" aria-labelledby="instructors-tab" tabindex="0">
                                <div class="courses__instructors-wrap">
                                    <div class="courses__instructors-thumb">
                                        <img src="{{BASE_URL}}/app/public/user/assets/img/courses/course_instructors.png" alt="img">
                                    </div>
                                ...
                                <div class="courses__rating-wrap">
                                    ...
                                    <div class="course-review-head">
                                        <div class="review-author-thumb">
                                            <img src="{{BASE_URL}}/app/public/user/assets/img/courses/review-author.png" alt="img">
                                        </div>
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="courses__details-sidebar">
                        <div class="courses__cost-wrap">
                            ...
                            <h2 class="title">${{$data['course']['price']}}</h2>
                        </div>
                        <div class="courses__information-wrap">
                            <h5 class="title">Course includes:</h5>
                            <ul class="list-wrap">
                                <li>
                                    <img src="{{BASE_URL}}/app/public/user/assets/img/icons/course_icon01.svg" alt="img" class="injectable">
                                    Level
                                    <span>Expert</span>
                                </li>
                                <li>
                                    <img src="{{BASE_URL}}/app/public/user/assets/img/icons/course_icon02.svg" alt="img" class="injectable">
                                    Duration
                                    <span>11h 20m</span>
                                </li>
                                <li>
                                    <img src="{{BASE_URL}}/app/public/user/assets/img/icons/course_icon03.svg" alt="img" class="injectable">
                                    Lessons
                                    <span>12</span>
                                </li>
                                <li>
                                    <img src="{{BASE_URL}}/app/public/user/assets/img/icons/course_icon04.svg" alt="img" class="injectable">
                                    Quizzes
                                    <span>145</span>
                                </li>
                                <li>
                                    <img src="{{BASE_URL}}/app/public/user/assets/img/icons/course_icon05.svg" alt="img" class="injectable">
                                    Certifications
                                    <span>Yes</span>
                                </li>
                                <li>
                                    <img src="{{BASE_URL}}/app/public/user/assets/img/icons/course_icon06.svg" alt="img" class="injectable">
                                    Graduation
                                    <span>25K</span>
                                </li>
                            </ul>
                        ...
                        <div class="courses__payment">
                            ...
                            <img src="{{BASE_URL}}/app/public/user/assets/img/others/momo.jpg" alt="img">
                        </div>
                        ...
                        <div class="courses__details-enroll">
                            <div class="tg-button-wrap">
                                <form action="{{route('bill-course')}}" method="POST">
                                    <input type="hidden" name="payUrl" value="paid">
                                    <input type="hidden" name="thanhTien" value="{{$data['course']['price'] }}">
                                    <input type="hidden" name="course_id" value="{{$data['course']['id']}}">
                                    <input type="submit" class="btn btn-two arrow-btn" value="Errol Now">
                                </form>
