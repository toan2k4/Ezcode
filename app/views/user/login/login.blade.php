...
<main class="main-area fix">
    ...
    <section class="breadcrumb__area breadcrumb__bg" data-background="app/public/user/assets/img/bg/breadcrumb_bg.jpg">
        ...
        <div class="breadcrumb__shape-wrap">
            ...
            <img src="app/public/user/assets/img/others/breadcrumb_shape02.svg" alt="img" data-aos="fade-right"
                data-aos-delay="300">
            <img src="app/public/user/assets/img/others/breadcrumb_shape03.svg" alt="img" data-aos="fade-up"
                data-aos-delay="400">
            <img src="app/public/user/assets/img/others/breadcrumb_shape04.svg" alt="img" data-aos="fade-down-left"
                data-aos-delay="400">
            <img src="app/public/user/assets/img/others/breadcrumb_shape05.svg" alt="img" data-aos="fade-left"
                data-aos-delay="400">
        </div>
    </section>
    <!-- breadcrumb-area-end -->
                    ...
                    <div class="singUp-wrap">
                        ...
                        <form action="<?= route('login')?>" method="post" class="account__form">
                            ...
                            <button type="submit" class="btn btn-two arrow-btn">Sign In<img
                                    src="app/public/user/assets/img/icons/right_arrow.svg" alt="img" class="injectable"></button>
                        </form>
