...
<!-- Mirrored from themegenix.com/demo/skillgro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jan 2024 14:20:59 GMT -->
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{BASE_URL}}app/public/user/assets/img/favicon.png">
    <!-- Place favicon.ico in the root directory -->

    <!-- CSS here -->
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/animate.min.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/fontawesome-all.min.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/flaticon-skillgro.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/swiper-bundle.min.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/default-icons.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/select2.min.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/odometer.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/aos.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/spacing.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/tg-cursor.css">
    <link rel="stylesheet" href="{{BASE_URL}}app/public/user/assets/css/main.css">
</head>
...
<body>
    ...
    <div id="preloader">
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class="loader-icon"><img src="{{BASE_URL}}app/public/user/assets/img/logo/preloader.svg" alt="Preloader"></div>
            </div>
        </div>
    </div>
    <!--Preloader-end -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="tg-header__top-info list-wrap">
                            <li><img src="{{BASE_URL}}app/public/user/assets/img/icons/map_marker.svg" alt="Icon"> <span>589 5th
                                    Ave, NY 10024, USA</span></li>
                            <li><img src="{{BASE_URL}}app/public/user/assets/img/icons/envelope.svg" alt="Icon"> <a
                    ...
                    <div class="col-lg-6">
                        <div class="tg-header__top-right">
                            <div class="tg-header__phone">
                                <img src="{{BASE_URL}}app/public/user/assets/img/icons/phone.svg" alt="Icon">Call us: <a
                    ...
                    <div class="col-12">
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                <div class="logo">
                                    <a href="<?= route('/')?>"><img src="{{BASE_URL}}app/public/user/assets/img/logo/logo.svg"
                                            alt="Logo"></a>
                                </div>
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-xl-flex">
                                    <ul class="navigation">
                                        <li class="active menu-item-has-children"><a href="index.php?url=/">Home</a>
                                        </li>
                                ...
                                <div class="tgmenu__action">
                                    ...
                                    <ul class="list-wrap">
                                        <!-- <li class="mini-cart-icon">
                                            <a href="shop.html" class="cart-count">
                                                <img src="{{BASE_URL}}app/public/user/assets/img/icons/cart.svg" class="injectable" alt="img">
                                    ...
                                    <div>
                                        <a href="?act=account">
                                            <img class="rounded-circle shadow-1-strong" src="./public/uploads/hghg.png"
                        ...
                        <div class="tgmobile__menu">
                            <nav class="tgmobile__menu-box">
                                ...
                                <div class="nav-logo">
                                    <a href="index.php"><img src="{{BASE_URL}}app/public/user/assets/img/logo/logo.svg"
                                            alt="Logo"></a>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer__widget">
                            <div class="logo mb-35">
                                <a href="index.html"><img src="{{BASE_URL}}app/public/user/assets/img/logo/secondary_logo.svg"
                                        alt="img"></a>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer__widget">
                                ...
                                <ul class="list-wrap footer__social">
                                    <li>
                                        <a href="https://www.facebook.com/" target="_blank">
                                            <img src="{{BASE_URL}}app/public/user/assets/img/icons/facebook.svg" alt="img"
                                                class="injectable">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/" target="_blank">
                                            <img src="{{BASE_URL}}app/public/user/assets/img/icons/twitter.svg" alt="img"
                                                class="injectable">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/" target="_blank">
                                            <img src="{{BASE_URL}}app/public/user/assets/img/icons/whatsapp.svg" alt="img"
                                                class="injectable">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/" target="_blank">
                                            <img src="{{BASE_URL}}app/public/user/assets/img/icons/instagram.svg" alt="img"
                                                class="injectable">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/" target="_blank">
                                            <img src="{{BASE_URL}}app/public/user/assets/img/icons/youtube.svg" alt="img"
                                                class="injectable">
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="app-download">
                                <a href="#"><img src="{{BASE_URL}}app/public/user/assets/img/others/google-play.svg" alt="img"></a>
                                <a href="#"><img src="{{BASE_URL}}app/public/user/assets/img/others/apple-store.svg" alt="img"></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- JS here -->
    <script src="{{BASE_URL}}app/public/user/assets/js/vendor/jquery-3.6.0.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/bootstrap.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/imagesloaded.pkgd.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/jquery.magnific-popup.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/jquery.odometer.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/jquery.appear.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/tween-max.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/select2.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/swiper-bundle.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/jquery.marquee.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/tg-cursor.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/vivus.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/ajax-form.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/svg-inject.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/jquery.circleType.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/jquery.lettering.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/wow.min.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/aos.js"></script>
    <script src="{{BASE_URL}}app/public/user/assets/js/main.js"></script>
    <script>
...
<!-- Mirrored from themegenix.com/demo/skillgro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jan 2024 14:21:11 GMT -->
